with open("2023/9/part_1_2_input.txt") as fobj:
    ...
    for sequence in sequences:
        ...
        sequence_breakdown[0] = [sequence_breakdown[0][0]] + sequence_breakdown[0]

        for i in range(1, len(sequence_breakdown)):
            sequence_breakdown[i] = [
                sequence_breakdown[i][0] - sequence_breakdown[i - 1][0]
            ] + sequence_breakdown[i]

        print(sequence_breakdown)
        res += sequence_breakdown[0][0]
